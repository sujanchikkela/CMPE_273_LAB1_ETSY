...
const ProductList = () => {
    ...
    return (
        <Fragment>
            <Row style={{ margin: 30 }}>
                <Col sm={2}>
                    <Button style={{ width: "100%" }} className='rounded' onClick={() => setShowApplyFilter(true)} variant='outline-secondary'>All filters</Button>
                </Col>
                <Col sm={5}>
                    {filters && filters.category.length > 0 ? (<Button className='rounded' variant='outline-secondary'>{filters.category}</Button>) : ""}
                    {filters && filters.price < 9999999 && filters.price.length > 0 ? (<Button className='rounded' variant='outline-secondary'>Price Under {filters.price}</Button>) : ""}
                </Col>
                <Col sm={3}>
                ...
                <Col sm={2}>
                    <Form.Select aria-label="Default select example" className='rounded' onChange={(e) => sortBy(e)}>
