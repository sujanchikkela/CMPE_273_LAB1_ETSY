        ...
        <Fragment>
            ...
            <Card style={{ marginLeft: "20%", marginRight: "20%", marginTop: 20 }}>
                ...
                <Card.Body>
                    ...
                    <Button style={{ width: "100%" }} className="rounded" variant="warning" onClick={() => saveChanges()}>Save Changes</Button>
                </Card.Body>
            </Card>
            ...
            >
                ...
                <Modal.Footer>
                    <Button variant="outline-secondary" className='rounded' onClick={() => setEditName(false)}>
                        Close
                    </Button>
                    <Button variant="outline-warning" className='rounded' onClick={() => updateName()}>Update</Button>
                </Modal.Footer>
            </Modal>
        </Fragment>
    )
