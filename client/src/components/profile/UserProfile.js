            ...
            <Card style={{ margin: 20 }}>
                    ...
                    <Row>
                        ...
                        <Col>
                            <Form className="d-flex" >
                                <FormControl
                                    type="search"
                                    placeholder="Search your favorites items here 🔍"
                                    className="me-1"
                                    aria-label="Search"
                                    name="searchFav"
                                    value={searchFav}
                                ...
                                />
                                <Button variant="outline-primary" onClick={()=>search()}> <i class="fa fa-search" aria-hidden="true"></i></Button>
                            </Form>
                        </Col>
                    </Row>
                </Card.Header>
                ...
                {favorites.length == 0 && (
                    <Row style={{textAlign:'center',margin:"10%"}}>
                        ...
                        <h4>Try adding items to this list</h4>
                    </Row>
                )}
