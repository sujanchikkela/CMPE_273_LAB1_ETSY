            ...
            {product && (
                <Row style={{ marginLeft: "15%", marginRight: "15%", marginTop: 20 }}>
                    ...
                    <Col sm={4}>
                        ...
                        <Button variant='outline-warning' className='rounded' onClick={(e)=>buyNow(e)} style={{width:"100%"}} disabled={quantity>0 &&  product.quantity > 0 ? false : true}>Buy it now</Button>
                        <br/>
                        <br/>
                        <Button variant='warning' className='rounded' onClick={(e)=>addToCart(e)} style={{width:"100%"}} disabled={quantity>0 && product.quantity > 0 ? false : true}>Add to cart</Button>
                    </Col>
                </Row>
            )}
