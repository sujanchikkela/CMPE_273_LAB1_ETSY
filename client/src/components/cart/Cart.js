        ...
        <Fragment>
            <Row style={{ marginLeft: '10%', marginRight: '10%', marginTop:25 }}>
                            ...
                            {cartItems && cartItems.map(item => (
                                <Row>
                                    ...
                                    <Col sm={5}>
                                        ...
                                        <br/>
                                        <Row>
                                            <Button variant='outline-secondary' onClick={()=>removeFromCart(item)} className='rounded'>Remove from Cart</Button>
                                        </Row>
                                    </Col>
                                    <Col sm={1}>
                ...
                <Col sm={4}>
                    <Card>
                        <Card.Body>
                            <Row><h4 style={{textAlign:'center'}}>Total Value of the Order</h4></Row>
                            <hr/>
                            <Row>
                            ...
                            <br/>
                            <Row>
                                <Button variant='primary' onClick={(e)=>{placeOrder(e)}} className='rounded'>Place Order</Button>
                            </Row>
                        </Card.Body>
                    </Card>
                </Col>
