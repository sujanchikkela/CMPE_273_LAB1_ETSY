            ...
            {shop && (
                <>
                        ...
                        <Card.Body>
                            <Row>
                                ...
                                <Col sm={3}>
                                    ...
                                    <Row><Button style={{ width: 'auto' }} className='rounded' variant='outline-primary' onClick={() => setEditShop(true)}>Edit Shop</Button></Row>
                                </Col>
                                <Col sm={5}></Col>
                                <Col sm={2}>
                                    <Row><h6 >Shop Owner details</h6></Row>
                                    <Image rounded width={100} height={100} src={shopOwner} />
                    ...
                    <Card style={{ margin: 20 }}>
                        ...
                        <Button style={{width: "100%", textAlign: "center" }} variant="secondary" onClick={(e) => setAddItem(true)}>Add new Item</Button>
                            <Row>
                                <Col sm={3}>
