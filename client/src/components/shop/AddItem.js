...
const AddItem = ({ addItem, setAddItem, sellerId, shop }) => {
    ...
    const saveItem = async (e) => {
        ...
        try {
            ...
            if (res.data) {
                toast.dark("New Item added successfully")
                setAddItem(false)
                window.location.reload(false)
            }
        } catch (error) {
                toast.dark("Failed to save new item!, Try again.")
        }
    ...
    return (
        ...
        >
            ...
            <Modal.Body style={{ height: 350, overflowY: 'auto' }}>
                <Card>
                    <Card.Body>
                        <Row style={{ margin: 20 }}>
                            <Col sm={3}>
                                <Image rounded width={120} height={120} src={defaultProfileImg} />
                            </Col>
                            <Col sm={3}></Col>
                            <Col>
                                <Form.Group controlId="formFile" className="mb-3">
                                    <Form.Label>Upload a picture for profile pic</Form.Label>
            ...
            <Modal.Footer>
                <Button varaint="primary" className="rounded" onClick={(e) => saveItem(e)} >Save Details</Button>
            </Modal.Footer>
        </Modal >
    )
}
