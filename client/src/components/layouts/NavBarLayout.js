...
const NavBarLayout = props => {
  ...
  return (
    <Fragment>
      <Navbar style={{backgroundColor:"white"}}  variant="dark" expand="lg">
        <Container fluid>

          <Col sm={1}></Col>

          <Col sm={3}>
            <Navbar.Brand href="#"><Link to="/dashboard" style={{ textDecoration: 'none', color: '#F56400' }}
            ><span style={{fontStyle: 'Georgia', fontSize: 28, fontWeight: 'bold' }}>Etsy 🛍</span></Link></Navbar.Brand>
          </Col>
                ...
                <>
                  <Nav.Link><Link to="/profile" >
                    <OverlayTrigger placement="bottom" overlay={<Tooltip id="button-tooltip-2">Favorites</Tooltip>}>
                      <i class="fa fa-heart-o"  style={{ color: 'black', fontSize: '25px' }} aria-hidden="true"></i>
                    </OverlayTrigger>
                  </Link></Nav.Link>
                  ...
                  <Nav.Link>
                    <Link to="/shop">
                      <OverlayTrigger placement="bottom" overlay={<Tooltip id="button-tooltip-2">Start Selling on ETSY!</Tooltip>}>
                        <i class="fa fa-home" style={{ color: 'black', fontSize: '25px' }} aria-hidden="true"></i>
                      </OverlayTrigger>
                    </Link>
                  </Nav.Link>
                  ...
                  <NavDropdown title={(<i class="fa fa-user-circle" style={{fontSize: '25px', color: 'black'}}aria-hidden="true"></i>)} id="basic-nav-dropdown">
