                ...
                <Modal.Header closeButton>
                    <Modal.Title id="contained-modal-title-vcenter">
                        <Row>
                            ...
                            <Col sm={4}>
                                <Button variant="primary" onClick={(e => { handleRegister(e) })} className='float-right rounded '>Register</Button>
                            </Col>
                        </Row>
                    </Modal.Title>
                </Modal.Header>
                <Modal.Body>
                    {signin && !register && (
                        <Form>
                            ...
                            <Button style={{ width: "100%" }} variant="primary" onClick={(e)=>onSubmitLogin(e)} className="rounded" type="submit">
                                Sign in
                            </Button>
                        </Form>
                    )}
